...
import { FaPlus, FaCloudUploadAlt, FaCheckCircle, FaBoxes, FaInfoCircle } from "react-icons/fa";

// Dummy categories (replace with real API later)
      ...
      <div className="w-full md:w-1/3 bg-gradient-to-b from-rose-600 to-pink-500 text-white rounded-2xl p-6 flex flex-col justify-between shadow-xl">
        <div>
          ...
          <p className="text-sm leading-relaxed opacity-90">
            Showcase your products with style. Make sure to provide all key details and stand out from the crowd. 🛍️
          </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <label className="mt-1 flex flex-col items-center justify-center w-full h-36 border-2 border-dashed rounded-md cursor-pointer bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-600">
              ...
              <span className="text-xs text-gray-600 dark:text-gray-400">Click or drag to upload image</span>
            </label>
            {preview && (
              <div className="mt-2">
                <img
          ...
          <button
            type="submit"
            className="w-full flex justify-center items-center gap-2 bg-green-600 text-white text-lg font-semibold py-3 rounded-lg hover:bg-green-700 transition"
          >
            <FaPlus /> Add Product
          </button>
        </form>
