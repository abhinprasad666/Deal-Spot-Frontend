...
import { uploadSellerCover, uploadSellerDp } from "../../../redux/actions/seller/sellerFrofileActions";
...
const SellerProfile = () => {
    ...
    const { loadingDp, loadingCover, error, upoladCoverImg, uploadProfileDp } = useSelector((state) => state.sellerProfile);
    const { loading, seller } = useSelector((state) => state.sellerData);
 
    const sampleCoverImg = "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1000&q=80";
    const sampleDp = "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200&q=80";
    ...
    return (
        <div className="max-w-3xl mx-auto p-4">
            ...
            <div className="relative mb-20">
                <img src={coverPreview} alt="Cover" className="w-full h-48 object-cover rounded-md" />
                <button
                ...
                {(coverFile || loadingCover) && (
                    <div className="absolute right-4 bottom-[-42px] text-right">
                        ...
                        {loadingCover && <p className="text-sm text-gray-600 mt-1">Uploading...</p>}
                    </div>
                )}
                ...
                <div className="absolute -bottom-12 left-4">
                    ...
                    {(profileFile || loadingDp) && (
                        <div className="mt-2 text-center">
                            ...
                            {loadingDp && <p className="text-sm text-gray-600 mt-1">Uploading...</p>}
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="mt-16 bg-white rounded shadow p-4 dark:text-gray-700 dark:bg-gray-800 dark:border dark:border-gray-400  ">
                ...
                <div className="mt-4 space-y-2">
                    ...
                    <p className="dark:text-gray-300">
                        <strong>Joined:</strong> {new Date(seller.createdAt).toLocaleDateString()}
                    </p>
                </div>
