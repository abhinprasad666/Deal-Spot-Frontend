                    ...
                    {isLoggedIn ? (
                        <div>
                            ...
                            >
                                ...
                                <Link to="/wishlist" className="block hover:text-gray-200">
                                    Wishlist
                                </Link>
                        ...
                        <>
                            <Link to={"/login"} className="block hover:text-gray-200 font-bold">
                                Login
                            </Link>
                            <Link to={"/signup"} className="block hover:text-gray-200 font-bold">
                                Signup
                            </Link>
                        </>
                    )}
