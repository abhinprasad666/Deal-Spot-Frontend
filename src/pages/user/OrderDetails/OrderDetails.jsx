...
const OrderDetails = () => {
    ...
    // Show full-page loader while fetching orders
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-screen">
                <ButtonLoader
                    message="Loading your order details"
                    bottomMessage="We’re making sure everything you ordered is listed right."
                    fullPage={true}
                />
            </div>
        );
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-10 bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 min-h-screen mt-30">
            ...
            {/* Review Modal */}
            <ProductReview isOpen={showModal} onClose={() => setShowModal(false)} product={selectedProduct} />
        </div>
    );
};
